/******/ (() => {
        ...
        var PlayGround = function PlayGround() {
          ...
          var getPosts = function getPosts() {
            axios__WEBPACK_IMPORTED_MODULE_1__["default"]
              .get(wpApiSettings.root + "wp-client-management/v1/posts/", {
                headers: {
              ...
              .then(function (response) {
                ...
                /* eslint-disable */ (_console = console).log.apply(
                  _console,
                  _toConsumableArray(
                    oo_oo("3718481361_15_12_15_38_4", response.data)
                  )
                );
          ...
          var getUsers = function getUsers() {
            axios__WEBPACK_IMPORTED_MODULE_1__["default"]
              .get(wpApiSettings.root + "wp-client-management/v1/users", {
                headers: {
                  "X-WP-Nonce": wpApiSettings.nonce,
                },
              })
              .then(function (response) {
                var _console2;
                /* eslint-disable */ (_console2 = console).log.apply(
                  _console2,
                  _toConsumableArray(
                    oo_oo("3718481361_30_12_30_38_4", response.data)
                  )
                );
                setPost(response.data);
              })
          ...
          var getSinglePost = function getSinglePost() {
            axios__WEBPACK_IMPORTED_MODULE_1__["default"]
              .get(wpApiSettings.root + "wp-client-management/v1/post/1", {
                headers: {
                  "X-WP-Nonce": wpApiSettings.nonce,
                },
              })
              .then(function (response) {
                var _console3;
                /* eslint-disable */ (_console3 = console).log.apply(
                  _console3,
                  _toConsumableArray(
                    oo_oo("3718481361_45_12_45_38_4", response.data)
                  )
                );
                setPost(response.data);
              })
  ...
  /* harmony import */ var _Components_Dashboard__WEBPACK_IMPORTED_MODULE_2__ =
    __webpack_require__(
      /*! ./Components/Dashboard */ "./src/Components/Dashboard.js"
    );
  /* harmony import */ var _Components_Clients__WEBPACK_IMPORTED_MODULE_3__ =
    __webpack_require__(
      /*! ./Components/Clients */ "./src/Components/Clients.js"
    );
  /* harmony import */ var _Components_Invoices__WEBPACK_IMPORTED_MODULE_4__ =
    __webpack_require__(
      /*! ./Components/Invoices */ "./src/Components/Invoices.js"
    );
  /* harmony import */ var _Components_Projects__WEBPACK_IMPORTED_MODULE_5__ =
    __webpack_require__(
      /*! ./Components/Projects */ "./src/Components/Projects.js"
    );
  /* harmony import */ var _Components_Schedules__WEBPACK_IMPORTED_MODULE_6__ =
    __webpack_require__(
      /*! ./Components/Schedules */ "./src/Components/Schedules.js"
    );
  /* harmony import */ var _Components_Reports__WEBPACK_IMPORTED_MODULE_7__ =
    __webpack_require__(
      /*! ./Components/Reports */ "./src/Components/Reports.js"
    );
  /* harmony import */ var _Components_Settings__WEBPACK_IMPORTED_MODULE_8__ =
    __webpack_require__(
      /*! ./Components/Settings */ "./src/Components/Settings.js"
    );
  /* harmony import */ var _Components_PlayGround__WEBPACK_IMPORTED_MODULE_9__ =
    __webpack_require__(
      /*! ./Components/PlayGround */ "./src/Components/PlayGround.js"
    );
  function _slicedToArray(r, e) {
    return (
      _arrayWithHoles(r) ||
  ...
  var App = function App() {
    ...
    switch (hash) {
      case "#clients":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Clients__WEBPACK_IMPORTED_MODULE_3__["default"],
            null
          );
        break;
      case "#projects":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Projects__WEBPACK_IMPORTED_MODULE_5__["default"],
            null
          );
        break;
      case "#invoices":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Invoices__WEBPACK_IMPORTED_MODULE_4__["default"],
            null
          );
        break;
      case "#schedules":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Schedules__WEBPACK_IMPORTED_MODULE_6__["default"],
            null
          );
        break;
      case "#reports":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Reports__WEBPACK_IMPORTED_MODULE_7__["default"],
            null
          );
        break;
      case "#settings":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_Settings__WEBPACK_IMPORTED_MODULE_8__["default"],
            null
          );
        break;
      case "#playground":
        component =
          /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            _Components_PlayGround__WEBPACK_IMPORTED_MODULE_9__["default"],
            null
          );
        break;
      default:
  ...
  document.addEventListener("DOMContentLoaded", function () {
    (0, react_dom__WEBPACK_IMPORTED_MODULE_1__.render)(
      ...
      document.getElementById("wp-client-management-root")
    );
  });
  /******/
})();
