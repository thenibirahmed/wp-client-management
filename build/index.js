...
var PlayGround = function PlayGround() {
  ...
  var getPosts = function getPosts() {
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(wpApiSettings.root + 'wp-client-management/v1/posts/', {
      ...
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3462934642_15_12_15_38_4", response.data)));
      setPost(response.data);
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3462934642_17_12_17_38_4", response.data)));
