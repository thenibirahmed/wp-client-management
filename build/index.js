...
var PlayGround = function PlayGround() {
  ...
  var getPosts = function getPosts() {
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(wpApiSettings.root + 'wp-client-management/v1/posts/', {
      ...
      var _console;
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3718481361_15_12_15_38_4", response.data)));
  ...
  var getUsers = function getUsers() {
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(wpApiSettings.root + 'wp-client-management/v1/users', {
      ...
      var _console2;
      /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3718481361_30_12_30_38_4", response.data)));
      setPost(response.data);
    })["catch"](function (error) {
      console.error('Error:', error);
    });
  ...
  var getSinglePost = function getSinglePost() {
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(wpApiSettings.root + 'wp-client-management/v1/post/1', {
      ...
      var _console3;
      /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3718481361_45_12_45_38_4", response.data)));
      setPost(response.data);
    })["catch"](function (error) {
      console.error('Error:', error);
    });
