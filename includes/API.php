...
use WpClientManagement\API\Clients\GetClientAdditionalInfo;
...
use WpClientManagement\API\Clients\UpdateClientAdditionalInfo;
...
class API {
    ...
    public function register_routes() {
        ...
        new GetClientAdditionalInfo();
        new UpdateClientAdditionalInfo();
        new EditClient();
